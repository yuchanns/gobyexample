...
func (tu *TodoUpdate) AddChildrenIDs(ids ...int) *TodoUpdate {
	tu.mutation.AddChildrenIDs(ids...)
	return tu
}
...
// RemoveChildrenIDs removes the "Children" edge to Todo entities by IDs.
func (tu *TodoUpdate) RemoveChildrenIDs(ids ...int) *TodoUpdate {
	tu.mutation.RemoveChildrenIDs(ids...)
	return tu
}
...
func (tu *TodoUpdate) RemoveChildren(t ...*Todo) *TodoUpdate {
	...
	return tu.RemoveChildrenIDs(ids...)
}
...
// AddChildrenIDs adds the "Children" edge to the Todo entity by IDs.
func (tuo *TodoUpdateOne) AddChildrenIDs(ids ...int) *TodoUpdateOne {
	tuo.mutation.AddChildrenIDs(ids...)
	return tuo
}
...
// RemoveChildrenIDs removes the "Children" edge to Todo entities by IDs.
func (tuo *TodoUpdateOne) RemoveChildrenIDs(ids ...int) *TodoUpdateOne {
	tuo.mutation.RemoveChildrenIDs(ids...)
	return tuo
}
...
func (tuo *TodoUpdateOne) RemoveChildren(t ...*Todo) *TodoUpdateOne {
	...
	return tuo.RemoveChildrenIDs(ids...)
}
